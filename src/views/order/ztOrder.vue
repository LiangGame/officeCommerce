      ...
      <el-dialog
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            ...
            <!--<span class="good_info" v-text="ruleForm.goodName"></span>-->
            <!--<el-input v-model="ruleForm.goodName"></el-input>-->
            <!--</el-form-item>-->
            <!--<el-form-item label="单价" prop="goodName">-->
            <!--<span class="good_info" v-text="ruleForm.price"></span>-->
            <!--</el-form-item>-->
            <!--<el-form-item label="数量" prop="goodName">-->
            <!--<span class="good_info">{{ruleForm.count}}</span>-->
            <!--</el-form-item>-->
            <!--<el-form-item label="总价" prop="goodName">-->
            <!--<span class="good_info">{{ruleForm.totalPrice}}</span>-->
            <!--</el-form-item>-->
            <!--<el-form-item label="商品图片" prop="goodDescribe">-->
            <!--<img :src="fileUrl+ruleForm.img" :alt="ruleForm.goodName">-->
            <!--</el-form-item>-->
          </el-col>
          <el-col :span="12">
            <!--<el-form-item label="用户名称" prop="goodName">-->
            <!--<span class="good_info">{{ruleForm.userID}}</span>-->
            <!--</el-form-item>-->
            <!--<el-form-item label="下单时间" prop="goodName">-->
            <!--<span class="good_info">{{ruleForm.cerateTime}}</span>-->
            <!--</el-form-item>-->
            <!--<el-form-item label="付款时间" prop="goodName">-->
            <!--<span class="good_info">{{ruleForm.payTime}}</span>-->
            <!--</el-form-item>-->
            <!--<el-form-item label="支付方式" prop="goodName">-->
            <!--<span class="good_info">{{ruleForm.payMent}}</span>-->
            <!--</el-form-item>-->
            <!--<el-form-item label="订单状态" prop="goodName">-->
            <!--<span class="good_info">{{ruleForm.status}}</span>-->
            <!--</el-form-item>-->
