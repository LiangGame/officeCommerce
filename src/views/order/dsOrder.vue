  ...
  <div class="dsOrder_container">
    <div class="main">
      ...
      <div class="table_container">
        <el-table
          ...
          <el-table-column
            ...
            align="center">
            <template slot-scope="scope">
              <!--<el-button :type="scope.row.status > 2 ?'primary':'danger'" size="small"-->
              <!--:disabled="scope.row.status > 2" @click="showOperate(scope.row.id)">-->
              <!--{{scope.row.status > 2 ? '已发货':'查看'}}-->
              <!--</el-button>-->
      ...
      <div style="line-height: 32px">
        ...
        <span style="color: #666;">共计已付款金额：{{orderTotal}}元  共计已返现金额：{{returnTotal}}元</span>
      </div>
      ...
      <el-dialog
        ...
        <el-row>
          ...
          <!--<el-col :span="24" align="center" v-if="goods.status>1">-->
          <!--<el-button type="primary" @click="confirmOrder(goods.id,goods.userID,goods.count,goods.goodID)">发货</el-button>-->
          <!--</el-col>-->
        </el-row>
      </el-dialog>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      confirmOrder(orderID, userID, count, goodID) {
        console.log(orderID, userID, count, goodID);
