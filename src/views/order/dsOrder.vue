  ...
  <div class="dsOrder_container">
    <div class="main">
      ...
      <div style="line-height: 32px">
        ...
        <span style="color: #666;">共计已付款金额：7000元    共计未付款金额：3500元   共计已返现金额：4600元</span>
      </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //获取订单列表
      loadData() {
        const data = {type:1,page: this.currentPage, pageSize: this.pageCount, payMent: this.payMent, status: this.status};
        this.$http({
